const tripData = {
  ...
  note:
    "這版已依照 7/12 的時間表調整：Day 1 下午進台南後接鴻牛、面交、Check in、漁光島、無醉、蓋拉與酒吧；Day 2 中午前後喝咖啡、吃牛肉湯再回台北。",
  summary:
    "主要時間以表格為準，市區移動先用各段之間的空檔吸收。15:30-17:00 保留給漁光島；晚上 21:00 後是便利商店酒精路跑站點，22:30 到 Moonrock 候位。",
  reminders: [
  ...
  days: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          imageAlt: "旅宿與放行李",
          note: "依截圖 15:00 Check in。先放行李，晚間酒精路跑從住宿附近出發。",
          tags: ["放行李", "停車確認"],
        },
        {
          type: "stop",
          ...
          imageAlt: "漁光島海邊與夕光",
          businessStatus: "戶外全天",
          note: "依截圖保留 15:30-17:00 給漁光島，放在 Check in 後去海邊走走剛好。",
          tags: ["海邊", "夕陽"],
        },
        {
          type: "stop",
          ...
          imageAlt: "冰品甜點",
          businessStatus: "營業待確認",
          note: "依截圖改到 17:00-17:30，先吃冰再去蓋拉漢堡。",
          tags: ["甜點", "國華街"],
        },
        {
          type: "stop",
