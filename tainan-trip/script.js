const tripData = {
  ...
  note:
    "這版先用「台北南下 → 東區牛肉湯 → 中西區住宿 → 國華街吃甜點漢堡 → 成功路酒吧」排動線。面交地點尚未確認，所以保留 15 分鐘彈性槽。",
  summary:
    "最順的核心是抵達台南時先處理東區的鴻牛，進中西區後把車停好，國華街周邊用步行串漢堡、甜點與宵夜。Moonrock 晚上從住宿步行過去，沿路把便利商店當補給點。",
  reminders: [
    "國華街、永樂市場周邊停車成本高，建議停好車後步行或短程計程車",
    "賣家面交地點若能約在住宿、國華街或東區鴻牛附近，整體最順",
    "便利商店酒精路跑抓 3-5 間補給點，實際店數以當晚 Google Maps 搜尋為準",
    "永樂牛肉湯當醒酒備案，出發前確認營業時間",
  ],
  days: [
    {
      id: "day-1",
      ...
      items: [
        ...
        },
        {
          ...
          imageAlt: "漢堡與薯條",
          note: "排成早晚餐交界，後面接甜點剛好。若中午牛肉湯吃太飽，可延後或改 Day 2。",
          tags: ["早晚餐", "國華街"],
        },
        {
          type: "drive",
        ...
        },
        {
          ...
          imageAlt: "冰品甜點",
          note: "漢堡後接冰店很順；若天氣太熱，也可以先吃冰再回住宿休息。",
          tags: ["甜點", "國華街"],
        },
        {
          type: "drive",
        ...
        },
        {
          ...
          travelMins: 35,
          parkingMins: 0,
          note: "沿成功路方向前進，便利商店補給點粗估 3-5 間；當晚用 Google Maps 搜尋 7-ELEVEN / 全家微調。",
        },
        {
          type: "stop",
          time: "20:55",
          ...
          imageAlt: "步行路線與補給點",
          note: "不要每間都停太久，設定 2-3 個正式補給點，其餘當路過備案。",
          tags: ["3-5 間", "步行"],
        },
        {
          type: "stop",
        ...
        },
        {
          ...
          category: "牛肉湯",
          status: "宵夜備案",
          address: "永樂市場／國華街三段周邊，實際地址待補",
          mapUrl: "https://www.google.com/maps/search/?api=1&query=%E6%B0%B8%E6%A8%82%E7%89%9B%E8%82%89%E6%B9%AF%20%E5%8F%B0%E5%8D%97",
          image: "assets/thumb-beef.svg",
          imageAlt: "深夜牛肉湯",
          note: "真的要醒酒可以放這裡；如果太晚或排隊，直接回住宿。",
          tags: ["醒酒", "可跳過"],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          image: "assets/thumb-route.svg",
          imageAlt: "回程前彈性補點",
          note: "如果 Day 1 漢堡或甜點沒吃到，這段補；若都完成，就提早回台北。",
          tags: ["備案", "不硬排"],
        },
        {
          type: "drive",
...
const renderStop = (item) => {
  ...
  const metaItems = [`停留 ${formatMins(item.durationMins || 0)}`, ...(item.tags || [])];
